...
def play_on_constraint_policy_runner(args):
    ...
    model_dict = torch.load(os.path.join('/media/ros207/data/tita_rl-master/tita_rl-master/logs/tita_constraint/Jan20_00-03-40_test_barlowtwins_feetcontact', 'model_500.pt'))
